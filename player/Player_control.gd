...
@export var zoom : Wand_button = Wand_button.A                # Bouton pour zoomer
@export var dezoom : Wand_button = Wand_button.Y              # Bouton pour dézoomer
@export var lock : Wand_button = Wand_button.X                # Bouton pour verrouiller/déverrouiller une annotation
@export var reinitialisation : Wand_button = Wand_button._1   # Bouton pour réinitialiser la position/rotation
@export var ajouter_modifier_annotation : Wand_button = Wand_button.STICK # Ajouter ou modifier une annotation
@export var menu : Wand_button = Wand_button.B                # Bouton pour afficher/masquer le menu
@export var saisie: Wand_button = Wand_button.GACHETTE        # Bouton pour saisir un objet
@export var supression_annotation = Wand_button._2            # Bouton pour supprimer une annotation

@export_category("option")
@export_range(1,1.9,0.05) var zoom_step := 1.2                # Facteur de zoom
@export_range(1,1.2,0.01) var length_pointeur_step = 1.02     # Facteur d'allongement du pointeur
...
var _last_node : PhysicsBody3D                # Dernier objet sélectionné
var _pointer = T5ToolsPointer                 # Référence au pointeur laser
var _node_pointed : PhysicsBody3D             # Objet actuellement pointé
var _origin : T5Origin3D                      # Origine de la scène Tilt Five
var _wand : T5Controller3D                    # Contrôleur Tilt Five
var _menu : Node                              # Référence au menu
var _thread : Thread                          # Thread pour calculer l'outline
var mutex := Mutex.new()                      # Mutex pour synchronisation

# Déplacement
var _pos : Vector3                            # Position courante du pointeur
var _first : bool                             # Indique la première saisie
var _distance_obj : float                     # Distance à l'objet saisi

# Rotation
var _initial_grab_rotation: Quaternion        # Rotation initiale lors de la saisie
var _is_grabbed = false                      # Indique si un objet est saisi

# Gestion des annotations
var _node_locked : Node3D                     # Annotation verrouillée
var outline_node : MeshInstance3D = null      # Outline de l'objet sélectionné
var outline_node_parent :MeshInstance3D = null# Outline du parent

# Changement de face d'une annotation
var reverse : bool                            # Inverse la direction du look_at
var changed : bool                            # Indique si le changement est possible

# =========================
# === Signaux ==
# =========================

signal new_comment(pos:Vector3,node:Node3D)   # Ajout d'une annotation
signal edit(comment:Node3D)                   # Modification d'une annotation
